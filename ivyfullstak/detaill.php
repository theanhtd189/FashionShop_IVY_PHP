...
<section class="detail">
    <div class="container">
        ...
        <h1>Mã đơn hàng:<span style="font-size: 20px; color: #378000;">JuLLy<?php $ma = substr($session_id, 0, 8);
                                                                            echo $ma   ?></span></h1>
        <div class="detail-text">
            <div class="detail-text-left-content">
                ...
                $show_order = $index->show_order($order_id);
                if ($show_order) {
                ...
                $show_payment = $index->show_payment($payment_id);
                if ($show_payment) {
            ...
            <div class="detail-text-right-content">
                ...
                <div class="detail-text-right">
                    <table>
                        ...
                        $SL = 0;
                        $TT = 0;
                        $show_carta = $index->show_carta($order_id);
                        if ($show_carta) {
        ...
        <br>
        <p style="text-align: center;">Mọi thắc mắc quý khách vui lòng liên hệ hotline <span style="font-size: 20px; color: red;">0934 578 478 </span> hoặc chat với kênh hỗ trợ trên website để được hỗ trợ nhanh nhất.</p>
    </div>
</section>
