...
public function insert_member($user_name,$user_password,$user_img){
            $query = "INSERT INTO tbl_user (user_name,user_password,user_img) VALUES ('$user_name','$user_password','$user_img')";
