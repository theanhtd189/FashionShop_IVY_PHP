...
<head>
    ...
    <script>
        var query = $("#tim-kiem-sp").val;
        $("#tksp").click(function(){
            alert(query);
        })
    </script>
    <title>Website - Jully</title>
</head>
                ...
                <div class="top-menu-icons">
                    <ul>
                        <li>
                            ...
                            <input type="text" placeholder="Tìm kiếm" id="tim-kiem-sp" name="q">                          
                            <button type="submit" id="btn-submit"></button>
                            <label for="btn-submit"><i class="fas fa-search" id="tksp"></i></label>
                            </form>
                        </form>
                         
                        </li>
                        <li><a href="profile.php" class="profile_link">                            
                            <i class="fas fa-user-secret"></i>
                        </a>
                        </li>
                        <li>
                            <a href="cart.php"><i class="fas fa-shopping-cart"></i><span>
                                    <?php if (Session::get('SL')) {
                                        echo Session::get('SL');
                                    } ?></span></a>
